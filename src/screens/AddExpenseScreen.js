    ...
    >
      ...
      <View style={s.pageHeader}>
        ...
        <Text style={s.pageSub}>
          {editingExpense ? 'Update the details below' : 'Fill in the details to log an expense'}
        </Text>
      </View>
      ...
      <View style={s.form}>
        ...
        <View style={s.fieldGroup}>
          ...
          <View style={s.amountWrap}>
            <View style={[s.currencyTag, { borderColor: errors.amount ? theme.danger : theme.primary + '40' }]}>
        ...
        <View style={s.fieldGroup}>
          ...
          <View style={s.categoryGrid}>
            {CATEGORIES.map(cat => {
              ...
              const catColor = theme.categories[cat]?.color || theme.primary;
              const catBg = theme.categories[cat]?.bg || theme.primaryGlow;
              return (
                <TouchableOpacity
                  key={cat}
                  style={[
        ...
        <View style={s.fieldGroup}>
          ...
          >
            <View style={s.dateBtnLeft}>
              <View style={[s.dateIconBox, { backgroundColor: theme.primaryGlow }]}>
                <Text style={[s.dateIconText, { color: theme.primary }]}>📅</Text>
              </View>
              <View>
            ...
            <View style={s.modalOverlay}>
              <View style={[s.modalSheet, { backgroundColor: theme.card, borderColor: theme.border }]}>
                <View style={s.modalHeader}>
                  ...
                  <Text style={[s.modalTitle, { color: theme.text }]}>Select Date</Text>
                  <TouchableOpacity onPress={confirmIOSDate} style={s.modalBtn}>
                    <Text style={[s.modalBtnText, { color: theme.primary }]}>Done</Text>
                  </TouchableOpacity>
                </View>
                <DateTimePicker
                  value={tempDate}
        ...
        <View style={s.fieldGroup}>
          ...
          <TextInput
            ...
            placeholderTextColor={theme.textMuted}
            value={notes}
            onChangeText={(t) => { setNotes(t); clearError('notes'); }}
            multiline
            maxLength={205}
            onFocus={() => setFocusedField('notes')}
            onBlur={() => setFocusedField(null)}
          />
          {errors.notes ? <Text style={s.errorText}>{errors.notes}</Text> : null}
        </View>
...
const makeStyles = (theme) => StyleSheet.create({
  ...
  pageSub: { fontSize: 13, color: theme.textMuted, fontWeight: '400' },
  form: { padding: 20 },
  ...
  optional: { fontSize: 10, fontWeight: '500', color: theme.textMuted, letterSpacing: 0.3 },
  input: {
  ...
  inputFocused: { borderColor: theme.primary, backgroundColor: theme.primaryGlow },
  inputError: { borderColor: theme.danger, backgroundColor: theme.danger + '08' },
  errorText: {
    fontSize: 11, color: theme.danger, fontWeight: '600',
    marginTop: 5, letterSpacing: 0.2,
  },
  amountWrap: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  currencyTag: {
    backgroundColor: theme.primaryGlow, borderRadius: 10,
  ...
  catChip: { paddingHorizontal: 16, paddingVertical: 9, borderRadius: 10, borderWidth: 1.5 },
  ...
  dateIconBox: { width: 36, height: 36, borderRadius: 10, justifyContent: 'center', alignItems: 'center' },
